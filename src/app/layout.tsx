...
export const metadata: Metadata = {
  ...
  description:
    "Discover Tenggis' portfolio, a frontend developer specializing in Next.js, and modern web development.",
  keywords: [
    "Tenggis",
    "Frontend Developer",
    "React Developer",
  ...
  openGraph: {
    ...
    description:
      "Explore projects and expertise in Next.js, and modern frontend development.",
  ...
  return (
    <html lang="en">
      <body
        className={
          inter.className +
          " overflow-x-hidden flex flex-col items-center mx-auto"
        }
      >
        <Analytics />
        <DotBg />
